...
import src.homeworks.eighth.interfaces.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        // System.out.println(Arrays.asList(secondArrayList.subList(0,
        // 1).toArray()).toString());
        ...
        // tmp.clear();
        // System.out.println(Arrays.asList(tmp.toArray()).toString() + " Here is
        // cleared array.");
        ...
        // System.out.println("indexes are " + test.indexOf("123") + " and " +
        // test.indexOf("1234567") + " and "
        // + test.indexOf("9777"));
